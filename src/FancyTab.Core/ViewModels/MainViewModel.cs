...
public partial class MainViewModel : ObservableObject
{
    ...
    public MainViewModel(IFileDialogService fileDialogService, ILocalizationService localizationService)
    {
        _localizationService = localizationService;
        _fileService = new FileService(fileDialogService);
        _pdfExportService = new PdfExportService(fileDialogService);
    ...
    private async Task ExportPdfAsync()
    {
        ...
        StatusText = success 
            ? _localizationService.GetString("Status_PdfExported", "PDF exported successfully") 
            : _localizationService.GetString("Status_PdfExportFailed", "PDF export failed");
    }
